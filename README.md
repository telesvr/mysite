...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mysite)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mysite
```

A live public deployment of this template is available at [https://mysite.templates.workers.dev](https://mysite.templates.workers.dev)
